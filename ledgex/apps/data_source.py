    ...
    children=[
        html.Div(
            ...
            children=[
                ...
                dcc.Markdown(
                    "Upload a Gnucash transaction CSV export, or any CSV file with matching columns.  See [Instructions](https://github.com/saufrecht/ledger-explorer/blob/master/docs/USAGE.md) for more information."
                ),  # NOQA
                dcc.Upload(
                    id="trans_file",
                    ...
                    children=[
                        ...
                        html.A(id="trans_select", children=" Select a file"),
                    ],
                ),
                dcc.Input(
                    className="url_input",
            ...
            children=[
                ...
                dcc.Upload(
                    ...
                    children=[
                        ...
                        html.A(id="atree_select", children=" Select a file"),
                    ],
                ),
                dcc.Input(
                    className="url_input",
            ...
            children=[
                ...
                dcc.Upload(
                    ...
                    children=[
                        ...
                        html.A(id="eras_select", children=" Select a file"),
                    ],
                ),
                dcc.Input(
                    className="url_input",
